...
<div class="container">
    ...
    <div class="row mt-3 container mb-3">
        <div class="row-md-6">
            ...
            <ul class="list-group">
                <?php foreach($mahasiswa as $mhs): ?>
                    <li class="list-group-item"><?= $mhs['nama']?>
                        ...
                        <a class="badge badge-success float-right m" href="<?= base_url();?>mahasiswa/ubah/<?= $mhs['id']; ?>" >Ubah</a>
                        <a class="badge badge-primary float-right m" href="<?= base_url();?>mahasiswa/detail/<?= $mhs['id']; ?>" >Detail</a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
